...
export default function ProductDetails() {
  ...
  return (
    <div className="mt-8 bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center space-x-5">
              {product.images.map((item) => (
                <div className="overflow-hidden rounded-lg aspect-h-2 aspect-w-3 max-w-[5rem] max-h-[5rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="object-cover object-center w-full h-full"
        ...
        <section>
          ...
          <div className="p-5 border">
            <Grid container spacing={7}>
              ...
              <Grid item>
                <h1 className="pb-1 text-xl font-semibold">Products Rating</h1>
        ...
        <section className="pt-10">
          ...
          <div className="flex flex-wrap items-center justify-center space-x-2 space-y-5">
            {mens_kurta.map((item) => (
