...
export default function Navigation() {
  ...
  const handleProduct = () => {
    navigate("/:levelOne/:levelTwo/:levelThree");
  };
                ...
                <Tab.Group as="div" className="mt-2">
                  ...
                  <Tab.Panels as={Fragment}>
                    {navigation.categories.map((category) => (
                      ...
                      >
                        <div className="z-50 grid grid-cols-2 gap-x-4">
                          {category.featured.map((item) => (
                            <div
                              key={item.name}
                              className="relative z-50 text-sm group"
                            >
                              <div className="z-50 overflow-hidden bg-gray-100 rounded-lg aspect-h-1 aspect-w-1 group-hover:opacity-75">
                                <img
                                  src={item.imageSrc}
                                  alt={item.imageAlt}
                              ...
                              <a
                                href={item.href}
                                className="z-50 mt-6 font-medium text-gray-900 zblock "
                              >
                                <span
              ...
              <div className="flex items-center ml-auto">
                <div className="">
                  ...
                  <div className="relative group">
                    {/* Circular Profile Icon with One Letter */}
                    {/* This part is will show hover when there is mouse on this div */}
                    <div
                    ...
                    {/* Dropdown on Hover */}
                    {/* This part will get hovered when mouse on the above part */}
                    <div className="absolute left-0 hidden mt-2 top-full group-hover:block ">
                      <div className="w-[6rem] m-0 bg-white h-[5rem] p-2 ">
